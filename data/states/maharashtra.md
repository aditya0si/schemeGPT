...
This is a discovery/coverage directory seed for Maharashtra. It confirms that
...
for Maharashtra has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in Maharashtra on the official national MyScheme
discovery portal:
...
eligibility for Maharashtra against the official national MyScheme discovery portal
