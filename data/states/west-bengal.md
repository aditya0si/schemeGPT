...
This is a discovery/coverage directory seed for West Bengal. It confirms that
...
for West Bengal has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in West Bengal on the official national MyScheme
discovery portal:
...
eligibility for West Bengal against the official national MyScheme discovery portal
