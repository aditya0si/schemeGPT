...
This is a discovery/coverage directory seed for Mizoram. It confirms that
...
for Mizoram has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in Mizoram on the official national MyScheme
discovery portal:
...
eligibility for Mizoram against the official national MyScheme discovery portal
