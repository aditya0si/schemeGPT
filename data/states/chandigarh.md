...
This is a discovery/coverage directory seed for Chandigarh. It confirms that
...
for Chandigarh has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in Chandigarh on the official national MyScheme
discovery portal:
...
eligibility for Chandigarh against the official national MyScheme discovery portal
