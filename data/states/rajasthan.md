...
This is a discovery/coverage directory seed for Rajasthan. It confirms that
...
for Rajasthan has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in Rajasthan on the official national MyScheme
discovery portal:
...
eligibility for Rajasthan against the official national MyScheme discovery portal
