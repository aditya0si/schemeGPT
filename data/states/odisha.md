...
This is a discovery/coverage directory seed for Odisha. It confirms that
...
for Odisha has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in Odisha on the official national MyScheme
discovery portal:
...
eligibility for Odisha against the official national MyScheme discovery portal
