...
This is a discovery/coverage directory seed for Delhi (NCT). It confirms that
...
for Delhi (NCT) has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in Delhi (NCT) on the official national MyScheme
discovery portal:
...
eligibility for Delhi (NCT) against the official national MyScheme discovery portal
