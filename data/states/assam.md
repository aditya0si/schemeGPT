...
This is a discovery/coverage directory seed for Assam. It confirms that
...
for Assam has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in Assam on the official national MyScheme
discovery portal:
...
eligibility for Assam against the official national MyScheme discovery portal
