...
This is a discovery/coverage directory seed for Punjab. It confirms that
...
for Punjab has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in Punjab on the official national MyScheme
discovery portal:
...
eligibility for Punjab against the official national MyScheme discovery portal
