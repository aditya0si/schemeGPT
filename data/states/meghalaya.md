...
This is a discovery/coverage directory seed for Meghalaya. It confirms that
...
for Meghalaya has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in Meghalaya on the official national MyScheme
discovery portal:
...
eligibility for Meghalaya against the official national MyScheme discovery portal
