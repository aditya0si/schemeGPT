...
This is a discovery/coverage directory seed for Himachal Pradesh. It confirms that
...
for Himachal Pradesh has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in Himachal Pradesh on the official national MyScheme
discovery portal:
...
eligibility for Himachal Pradesh against the official national MyScheme discovery portal
