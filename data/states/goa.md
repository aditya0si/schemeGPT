...
This is a discovery/coverage directory seed for Goa. It confirms that
...
for Goa has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in Goa on the official national MyScheme
discovery portal:
...
eligibility for Goa against the official national MyScheme discovery portal
