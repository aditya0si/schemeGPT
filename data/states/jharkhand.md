...
This is a discovery/coverage directory seed for Jharkhand. It confirms that
...
for Jharkhand has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in Jharkhand on the official national MyScheme
discovery portal:
...
eligibility for Jharkhand against the official national MyScheme discovery portal
