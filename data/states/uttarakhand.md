...
This is a discovery/coverage directory seed for Uttarakhand. It confirms that
...
for Uttarakhand has not been individually verified yet, and no state scheme names,
benefit amounts, or eligibility decisions are claimed here.

## Official discovery

Search for schemes available in Uttarakhand on the official national MyScheme
discovery portal:
...
eligibility for Uttarakhand against the official national MyScheme discovery portal
